...
**F-IF.B.4** For a function that models a relationship between two quantities, interpret key features of graphs and
...
**F-BF.A.1b** Write a function that describes a relationship between two quantities. Combine standard function types
