...
- **A-REI.C.6**: Solve systems of linear equations exactly and approximately (e.g., with graphs), focusing on linear equations in three variables.

- **A-REI.C.7**: Solve a simple system consisting of a linear equation and a quadratic equation in two variables algebraically and graphically. _For example, find the points of intersection between the line y = −3x and the circle x² + y² = 3._
