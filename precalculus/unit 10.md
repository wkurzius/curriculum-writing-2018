...
- It is important to understand how data was collected in order to draw valid conclusions from it. Statistical analysis and data displays often reveal patterns that may not be obvious.
